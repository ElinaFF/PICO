...
METADATA_PATH = "../pico_project/s_MTBLS28_merged.csv"
DATAMATRIX_PATH = "../pico_project/MTBLS28_CombinedData2_forML.csv"
...
def SPLITS_setup_classification_designs(controller):
    ...
    controller.set_target_columns(["Factor Value[Sample Type]"])
    ...
    controller.add_classification_design({"1TotalCases": ["Case"], "0TotalCtrls": ["Control"]})
...
def SPLITS_setup_splits_and_balancing(controller, proportion_splits , nbr_splits):
    """
    controller : Controller object
    ...
    controller.set_balance_correction_for_experiment("1TotalCases_vs_0TotalCtrls", 0)
    #controller.set_balance_correction_for_experiment("NEG_Case_Current_vs_Ctrl_Current", 15)
    #controller.set_balance_correction_for_experiment("NEG_Case_Former_vs_Ctrl_Former", 0)
    #controller.set_balance_correction_for_experiment("NEG_Case_Never_vs_Ctrl_Never", 21)
