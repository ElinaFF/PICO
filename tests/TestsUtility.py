...
MOCKED_CLASSIFICATION_DESIGN_CLASS = Mock(name="MockedClassificationDesign")
MOCKED_CLASSIFICATION_DESIGN = MOCKED_CLASSIFICATION_DESIGN_CLASS.return_value
MOCKED_CLASSIFICATION_DESIGN.get_classes_design.return_value = CLASSES_DESIGN
MOCKED_CLASSIFICATION_DESIGN.get_name.return_value = EXPERIMENT_NAME
MOCKED_CLASSIFICATION_DESIGN.get_full_name.return_value = EXPERIMENT_FULL_NAME
MOCKED_CLASSIFICATION_DESIGN.get_results.return_value = EXP_RESULTS
MOCKED_CLASSIFICATION_DESIGN.get_is_done.return_value = True

EXPERIMENT_DESIGNS = {EXPERIMENT_NAME: MOCKED_CLASSIFICATION_DESIGN}
...
MOCKED_METABOEXPERIMENT.get_classification_designs.return_value = EXPERIMENT_DESIGNS
...
MOCKED_METABOEXPERIMENT_DTO.classification_designs = EXPERIMENT_DESIGNS
