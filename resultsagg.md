...
All graphs can be saved and will be saved by default in SVG format. This can be changed in the ResultAggregatedTab.py file at the beginning of the file.
